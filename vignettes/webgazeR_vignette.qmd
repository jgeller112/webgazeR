...
gaze_sub <- webgazeR::downsample_gaze(gaze_sub, bin.length=200, timevar="time", aggvars=c("condition", "time_bin"))
...
```{r}
gaze_sub <- downsample_gaze(gaze_sub, bin.length=200, timevar="time", aggvars=c("condition", "time_bin"))
```
