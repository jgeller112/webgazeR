...
<tr><td style = "white-space: collapse; font-family: monospace; vertical-align: top"><code id="window_size">window_size</code></td>
<td>
Integer, window length in time points (default 10).
</td></tr>
<tr><td style = "white-space: collapse; font-family: monospace; vertical-align: top"><code id="step">step</code></td>
<td>
Integer, step size between consecutive windows (default 1).
</td></tr>
<tr><td style = "white-space: collapse; font-family: monospace; vertical-align: top"><code id="min_overlap">min_overlap</code></td>
<td>
...
<tr><td style = "white-space: collapse; font-family: monospace; vertical-align: top"><code id="return_per_window">return_per_window</code></td>
<td>
