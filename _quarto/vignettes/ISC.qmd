...
This vignette demonstrates how to calculate ISC using two commonly used approaches:
	...
	2.	Leave-One-Out ISC Approach
	- Here, each participant’s data is correlated with the mean time series of all other participants, excluding their own data.
	- This results in one correlation value for each participant. 
